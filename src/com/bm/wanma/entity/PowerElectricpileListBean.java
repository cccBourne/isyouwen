 ...
 * 电站详情二级 电桩列表
 */
public class PowerElectricpileListBean implements Serializable{
	
    private String elictricPicId;//电桩ID
    private String elictricPicName;//电桩名称
    private String picPowerSum;//枪口数量
    private String elpiState;//电桩状态 (10-离线15-上线）（非智能，智能）
    private String elictricPicImage;//电桩ID
    private String raIn_ReservationRate;//预约单价
    private String elpiChargingmode;//5 直流桩（快充） 14 交流桩（慢充）
    private String elpiPowersize;//电桩功率
    private String elpiPowerinterface;//7国标 19美标 20欧标
    private String raIn_ServiceCharge;//电桩服务费（也即电站服务费）
    private String currentRate;//电费
    private String ep_num;//电桩在电站中的排序号
    private String comm_status;//电桩连接状态，0断开，1连接（0时即便是智能桩也不能操作）
    private String epaddr;//电桩地址
    private String ownerCompany;//电桩所属 0其他，1爱充网，2国网，3特斯拉
    
    private String rateId;//电桩费率
	/*枪头列表*/
