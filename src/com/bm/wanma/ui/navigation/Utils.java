...
public static final int STATIONDETAIL=1;//地图详情界面
public static final int LISTMODE=2;//列表界面
public static final int ANCHORSUMMARY=3;//锚点详情
public static final int MYCOLLECT=4;//我的收藏
public static final int CARREPAIR =5;//车辆维修
public static final int BESPOKEDETAIL=6;//预约详情界面
